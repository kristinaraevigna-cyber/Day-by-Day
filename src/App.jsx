...
// Incorporating KLI Leadership Competency Model
// ============================================================================
...
const Icons = {
  ...
  Network: () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="5" r="3"/><circle cx="5" cy="19" r="3"/><circle cx="19" cy="19" r="3"/><line x1="12" y1="8" x2="5" y2="16"/><line x1="12" y1="8" x2="19" y2="16"/></svg>),
  ...
  ClipboardCheck: () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M9 14l2 2 4-4"/></svg>)
};
...
// ============================================================================
// KLI LEADERSHIP COMPETENCY MODEL (Day, 2024)
// ============================================================================
    ...
    capabilities: [
      {
        id: 'resilience',
        name: 'Resilience',
        description: 'Courage to bounce back and learn from setbacks',
        image: PHOTOS.resilience,
        attributes: ['Persistence', 'Adaptability', 'Growth mindset', 'Optimism', 'Emotion management']
      },
      {
        id: 'entrepreneurial',
        name: 'Entrepreneurial Mindset',
        description: 'Courage to take risks and act boldly',
        image: PHOTOS.entrepreneurial,
        attributes: ['Enterprising', 'Resourceful', 'Initiative', 'Bold', 'Challenge']
      },
      {
        id: 'responsible',
        name: 'Responsible Action',
        description: 'Courage to act in accordance with your values',
        image: PHOTOS.responsible,
        attributes: ['Insight', 'Modeling', 'Integrity', 'Convictions', 'Advocacy']
      }
    ]
  },
  {
    ...
    capabilities: [
      {
        id: 'innovation',
        name: 'Innovation',
        description: 'Generate new ideas and challenge the status quo',
        image: PHOTOS.innovation,
        attributes: ['Generating ideas', 'Openness to change', 'Visioning', 'Challenge status quo', 'Flexibility']
      },
      {
        id: 'communication',
        name: 'Communication',
        ...
        attributes: ['Expressive', 'Listen actively', 'Persuasive', 'Inquiry', 'Dialogue']
      },
      {
        id: 'problemsolving',
        name: 'Problem Solving',
        description: 'Analyze situations and make sound decisions',
        image: PHOTOS.problemsolving,
        attributes: ['Information seeking', 'Analyzing data', 'Anticipates problems', 'Decision making', 'Solution driven']
      }
    ]
  },
  {
    ...
    capabilities: [
      {
        id: 'empathy',
        name: 'Empathy',
        description: 'Understand and connect with others perspectives',
        image: PHOTOS.empathy,
        attributes: ['Perceptive', 'Curious', 'Diversity', 'Inclusive', 'Sensitivity']
      },
      {
        id: 'sociallearning',
        ...
        attributes: ['Social awareness', 'Engages others', 'Networking', 'Nurturing relationships', 'Situational learning']
      },
      {
        id: 'teamwork',
        name: 'Teamwork',
